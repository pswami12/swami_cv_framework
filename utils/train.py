...
def train_model(model_name, resume, device, norm, epochs, batch_size, learning_rate, pretrained):
    ...
    print(f"................{batch_size}")
    train_loader, test_loader, classes, class_to_idx = dataloaders(train_batch_size=batch_size, val_batch_size=batch_size,)
    
    print(class_to_idx)
    model = ResNet18(pretrained = pretrained, num_classes = len(classes)).to(device)
